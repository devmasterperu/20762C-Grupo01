...
--select REPLICATE('9',CAST(RAND() * 100 AS int))
...
--Table 'PhoneLog'. Scan count 1, logical reads 1605, physical reads 0, read-ahead reads 0, lob logical reads 0, lob physical reads 0, lob read-ahead reads 0.
--Table 'Product'. Scan count 1, logical reads 6, physical reads 1, read-ahead reads 24, lob logical reads 0, lob physical reads 0, lob read-ahead reads 0.
...
alter table [PhoneLog] add state bit default 1
go
update [PhoneLog]
set state=0
