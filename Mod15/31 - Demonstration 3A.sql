...
SELECT SpatialLocation,AddressID FROM Person.Address --where SpatialLocation --is not null
...
LEFT JOIN Person.BusinessEntityAddress AS ea
...
WHERE a.SpatialLocation IS NOT NULL
 ...
 SELECT TOP(1)
        ...
        sp2.FirstName,
        sp2.LastName,
        sp1.SpatialLocation.STDistance(sp2.SpatialLocation) / 1000 AS DistanceKms
