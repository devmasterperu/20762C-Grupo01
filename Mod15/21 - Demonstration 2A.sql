...
--SELECT @NewYork.STUnion(@LosAngeles);
SELECT @NewYork.STDistance(@LosAngeles);
GO

-- Step 7 - Draw the Pentagon

DECLARE @Pentagon1 geography= geography::STPolyFromText(
  'POLYGON(( -77.0532219483429 38.870863029297695,-77.05468297004701 38.87304314667469,-77.05788016319276 38.872800914712734,
             -77.05849170684814 38.870219840133124,-77.05556273460198 38.8690670969195,-77.0532219483429 38.870863029297695),
           ( -77.05582022666931 38.8702866652523,-77.0569360256195 38.870734733163644,-77.05673214773439 38.87170668418343,
             -77.0554769039154 38.871848684516294,-77.05491900444031 38.87097997215688,-77.05582022666931 38.8702866652523))',
           4326);
...
--https://docs.microsoft.com/en-us/sql/relational-databases/spatial/linestring?view=sql-server-ver15
...
SET @PanamaCanal = geography::STLineFromText('LINESTRING( -79.909 9.339, -79.536 8.942 )',4326);
